...
```sh
sudo wget http://download.sonatype.com/nexus/3/nexus-3.60.0-02-unix.tar.gz 
sudo tar -zxvf nexus-3.60.0-02-unix.tar.gz
sudo mv /opt/nexus-3.60.0-02 /opt/nexus
sudo rm -rf nexus-3.60.0-02-unix.tar.gz
```
